#!/bin/bash
# Run only Stage 1 from pipeline_math.sh: Hendrycks Math holdout trace generation.
# Usage Example: EXP_DIR=./experiments ./pipeline_math_stage1.sh
...
duration=$SECONDS
printf "${WHITE}\nMath Stage 1 completed in %02dh:%02dm:%02ds${RESET}\n" \
